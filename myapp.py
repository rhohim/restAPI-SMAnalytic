...
database = 'sqlite:///' + os.path.join(filename, 'dbtest.sqlite')
...
api.add_resource(category, "/category", methods=["POST","GET","DELETE"])
api.add_resource(catto2, "/category/<id>" , methods=["PUT","DELETE"])

api.add_resource(categoryall, "/category/populate", methods=["GET"])
api.add_resource(categoryallid, "/category/populate/<id>", methods=["GET"])
